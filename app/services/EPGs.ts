...
export const getPlutoEPG = async ( channelId: string = '1013' ) => {
    try{ 
...
export const getAmazonEPG = async (channelId: string = '253') => {
    try{ 
        const response = await fetch('/api/EPGs/Amazon/' + channelId, {
            method: 'GET',
            headers: {
            'Content-Type': 'application/json',
            },
